...
func noticeFor(code string) *Flash {
	...
	messages := map[string]string{
		...
		"queue-review":         "An earlier attempt may already have booked a pass for this profile and date. Check Yodel before retrying.",
		...
		"profile-disabled":     "Enable the linked profile before starting a job.",
		...
		"pairing-unavailable":  "Pairing could not start. Check that this OTP source is linked to an enabled profile, then try again.",
	}
